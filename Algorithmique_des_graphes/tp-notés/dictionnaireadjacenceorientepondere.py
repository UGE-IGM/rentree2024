...
class DictionnaireAdjacenceOrientePondere(object):
    ...
    def ajouter_arc(self, u, v, poids):
        ...
        # de par l'asymétrie du graphe, l'ajout de l'arc (u, v) ne rajoute 
        # pas automatiquement v aux sommets ; on doit donc le faire 
    ...
    def degre(self, sommet):
        ...
        une erreur."""
        if sommet not in self.__dictionnaire:
    ...
    def degre_entrant(self, sommet):
        """Renvoie le nombre de prédécesseurs du sommet ; s'il n'existe pas, provoque
        une erreur."""
        if sommet not in self.__dictionnaire:
            raise ValueError("sommet " + str(sommet) + " inexistant")
        return sum(
    ...
    def poids_arc(self, u, v):
        ...
        for voisin, poids in self.__dictionnaire[u].items():
            if voisin == v:
                return poids
    ...
    def sommets(self):
        ...
        return self.__dictionnaire.keys()
    ...
    def successeurs(self, sommet):
        ...
        return self.__dictionnaire[sommet].keys()
